...
// Vendored verbatim from OpenTofu internal/tfplugin5/tfplugin5_grpc.pb.go at
// tag v1.12.3 (Copyright (c) The OpenTofu Authors, MPL-2.0) — the same tag
// internal/provider/proto/tfplugin6/tfplugin6_grpc.pb.go and rpc.go's
// rpcTerraformVersion are pinned to. See
// internal/provider/tfplugin5_adapter.go for the tfplugin5<->tfplugin6
// translation layer.
