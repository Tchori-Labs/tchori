...
// Vendored verbatim from OpenTofu internal/tfplugin5/tfplugin5.pb.go at tag
// v1.12.3 (Copyright (c) The OpenTofu Authors, MPL-2.0) — the same tag
// internal/provider/proto/tfplugin6/tfplugin6.pb.go and rpc.go's
